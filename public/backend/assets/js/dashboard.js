(function ($) {
    ...
    // custom codes
    // Success Alert (session message from Laravel)
    ...
    window.confirmDelete = confirmDelete;
     ...
     // Custom code for showing profile image when the image selected
    $('#image__input').change(function (event) {
        let reader = new FileReader();
        reader.onload = function () {
            $('#image__preview').attr('src', reader.result).show();
            $('#image__preview').attr('class', 'd-block', 'mb-3');
        }
